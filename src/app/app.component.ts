...
export class MyApp {
  ...
  pages: any[] = [
    { title: 'Previous Recommendation', component: PreviousRecommendation },
    { title: 'Add New Recommendation', component: AddNewRecommendation },
    { title: 'Select Crop Growth', component: SelectCropGrowth },
    { title: 'Input Data', component: InputDataTable },    
